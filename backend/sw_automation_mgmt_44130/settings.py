"""
Django settings for sw_automation_mgmt_44130 project.
...
ROOT_URLCONF = 'sw_automation_mgmt_44130.urls'
...
WSGI_APPLICATION = 'sw_automation_mgmt_44130.wsgi.application'
...
SPECTACULAR_SETTINGS = {
    ...
    "TITLE": "sw_automation_mgmt_44130 API",
    "DESCRIPTION": "API documentation for sw_automation_mgmt_44130 App",
    "VERSION": "v1",
}
